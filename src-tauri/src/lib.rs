...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            nibi::check_remote_fluorcast_installation,
            nibi::provision_remote_fluorcast,
            nibi::install_remote_model_bundle,
            nibi::submit_remote_model_training,
            nibi::get_remote_provisioning_status,
            nibi::cancel_remote_provisioning_training,
